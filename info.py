...
PICS = (environ.get('PICS', 'https://graph.org/file/25cb604bc63ea1160820d-b7f09efd464d63fd8f.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002364135159').split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '1002878005579').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MovieClub:MovieClub@cluster0.dau2bnj.mongodb.net/MovieClub?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/f938c573ec7c53b3c1f91-ea04543ea5c8b49a22.jpg') # payment code picture url.
...
'- 120ʀs - 3 ᴍᴏɴᴛʜs\n'
'- 220ʀs - 6 ᴍᴏɴᴛʜs\n\n'
'🔰 ᴄᴏɴᴛᴀᴄᴛ ᴡɪᴛʜ <a href="https://t.me/RDX1444">RDX</a> ꜰᴏʀ ᴘᴀʏᴍᴇɴᴛ\n\n'
